      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title"><?php echo __('Editar Cargo'); ?></h3>
          </div>
          <!-- /.box-header -->
          <!-- form start -->
          <?php echo $this->Form->create($staff, ['role' => 'form']); ?>
            <div class="box-body">
              <?php
                echo $this->Form->control('staff',['label' => 'Cargo']);
                echo $this->Form->control('category_id', ['options' => $categories , 'label' => 'Categoria']);
