    ...
    <div class="eltdf-container-inner clearfix" style="margin-top: 10%">
        <div class="eltdf-grid-row ">
            <div class="eltdf-page-content-holder eltdf-grid-col-12">
                <div class="eltdf-blog-holder eltdf-blog-masonry eltdf-blog-pagination-standard eltdf-masonry-images-fixed eltdf-blog-type-masonry eltdf-blog-three-columns eltdf-normal-space eltdf-blog-masonry-in-grid"
                     data-blog-type="masonry" data-next-page="2" data-max-num-pages="2" data-post-number="11"
                     data-excerpt-length="30" data-category="lifestyle">
                    <div class="eltdf-blog-holder-inner eltdf-outer-space"
                         style="position: relative; height: 2970.3px; opacity: 1;">
                                    ...
                                    <div class="eltdf-post-heading">
                                        ...
                                        <div class="eltdf-post-image">
                                            <a itemprop="url" href="" title="<?php echo $post->titulo ?>">
                                                <img width="1300" height="798" src="/images/" <?= $post->foto ?>
                                                     class="attachment-full size-full wp-post-image" alt="a"
                                                     srcset="<?= "/files/StaffPosts/photo/" . $post->photo ?> 1300w, <?= "/files/StaffPosts/photo/" . $post->photo ?> 600w, <?= "/files/StaffPosts/photo/" . $post->photo ?> 300w, <?= "/files/StaffPosts/photo/" . $post->photo ?> 768w, <?= "/files/StaffPosts/photo/" . $post->photo ?> 1024w"
                                        ...
                                        <div class="eltdf-post-text-inner">
                                            <div class="eltdf-post-info-top">
                                                <div itemprop="dateCreated"
                                                    ...
                                                    <a itemprop="url"
                                                       href="https://gourmand.elated-themes.com/2018/01/">
                                            ...
                                            <div class="eltdf-post-text-main">
                                                ...
                                                <h5 itemprop="name" class="entry-title eltdf-post-title">
                                                    <a itemprop="url"
                                                       href="<?= $this->Url->build("servicos/cargos/{$post->id}") ?>"
