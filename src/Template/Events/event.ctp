...
<section id=content-section-2>
    <div class="gdlr-color-wrapper  gdlr-show-all no-skin"
        ...
        <div class=gdlr-page-title-wrapper>
            ...
            <div class="gdlr-page-title-container container"><h1 class="gdlr-page-title">Eventos</h1> <span
            ...
            <div class=container>
                <div class="gdlr-item-title-wrapper gdlr-item pos-center gdlr-nav-container ">
                    <div class=gdlr-item-title-head><h3
                                class="gdlr-item-title gdlr-skin-title gdlr-skin-border"><?= $event->name ?></h3>

                        <div class=clear></div>
                    </div>
                </div>
                <div class="room-item-wrapper type-modern" style=" font-size: 17px;">
                    <p><?= $event->text?></p>
                                            ...
                                            <li class="gdlr-item gdlr-modern-room">
                                                ...
                                                <div class=gdlr-room-thumbnail style="width: 350px; height: 233px">
                                                    ...
                                                    <a href="#" id="link1" data-toggle="modal" data-target="#myModal">
                                                        ...
                                                        <img class="open" src=/../files/PhotosEvents/photo/<?= $image->photo ?>
 alt width=700 height=400>
                ...
                <?php if(!empty($event->url)){?>
                        ...
                        <div style="max-width: 50%; height: 50%;margin-left: 25%"><?= $event->url?></div>
