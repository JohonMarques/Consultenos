...
class BlogsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'button' => ['type' => 'string', 'fixed' => true, 'length' => 1, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'created' => '2019-04-22 14:21:44',
                'modified' => '2019-04-22 14:21:44',
